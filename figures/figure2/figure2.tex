...
% Mode 2    
\node [node blue, align=center, text=white] (C1) [left= 2cm of blank1] { Consumers 1 \\ ($N_2$) };

% Plants
\node[below=3cm of C1](blank2){};
\node [ node green, align=center, text=white, left= 6cm of blank2] (R1) { Primaray\\ producer 1 \\ ($N_1$) };

% Mode 2    
\node [node, fill=black!30!myblue, align=center, text=white] (C2) [right= 2cm of blank1] { Consumers 2\\ ($N_5$) };
...
\node [ node, fill={black!30!mygreen}, align=center, text=white, right= 6cm of blank3] (R2) { Primary\\ producer 2\\ ($N_6$) };
