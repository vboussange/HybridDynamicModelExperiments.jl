...
include("../../src/beninca/tdep_param.jl")
...
mr_hybrid = hcat(model_hybrid.fun.(tsteps_days, Ref(res_inf.p_trained))...)'
ax_mortality = plot(mr_hybrid, title="params", xlabel="Days", ylabel="params", yscale=:log10)
