...
data_partial = data[2:3,:]
println("Warming up...")
run_simulations([simulation_parameters[1] for p in workers()], 1, data_partial) # precompilation for std model

println("Starting simulations...")
results = run_simulations(simulation_parameters, Epochs, data_partial)
