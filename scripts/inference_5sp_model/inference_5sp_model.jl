#=
Running inference simulations with `Model5SP`, for different meta parameter values.
...
const Epochs = [5000]
const TrueParameters = ComponentArray(ω = Float32[0.2],
                                    H = Float32[2.89855, 7.35294, 2.89855, 7.35294],
                                    q = Float32[1.38, 0.272, 1.38, 0.272],
                                    r = Float32[1.0, -0.15, -0.08, 1.0, -0.15],
                                    A = Float32[1.0, 1.0])
const TrueInitialState = Float32[0.77, 0.060, 0.945, 0.467, 0.18]
const TimeSteps = range(500f0, step=4, length=100)
const TimeSpan = (0f0, TimeSteps[end])
const MyModel = Model5SP
