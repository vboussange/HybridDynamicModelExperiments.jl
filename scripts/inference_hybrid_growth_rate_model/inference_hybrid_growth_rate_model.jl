#=
Running inference simulations with `SimpleEcosystemModel3SP` and
`HybridGrowthRateModel`, for data generated by `SimpleEcosystemModel3SPStar` (time
...
function generate_date(ss)
    ...
    model = SimpleEcosystemModel3SPStar(ModelParams(; u0=TrueInitialState, model_params...))
    for s in ss
